    ...
    <>
      <div className='border-gray-300 border-b-[1px] py-2 flex flex-row items-center justify-between'>
        <div className="flex justify-start items-center ">
          <PiPhoneCallFill size={28} color='green' className="hidden md:block" />
          <span className='text-green-700 text-sm md:text-xl ml-2 font-black'>1174</span>
          <h4 className='text-gray-500 text-sm md:text-lg ml-4 cursor-pointer'>Biz haqimizda</h4>
          <h4 className='text-gray-500 text-sm md:text-lg ml-4 cursor-pointer'>Bo'sh ish o'rinlari</h4>
        </div>
        <Select
          value={lang}
          onChange={setLang}
      ...
      <div className=" w-full flex flex-col md:flex-row justify-between my-5">
        ...
        {/* Login and coins */}
        <div className="flex items-center flex-row  justify-end md:justify-start gap-4">
